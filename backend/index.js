 ...
 * @returns {{ name: string, surname: string, lastname: string, birthday: string, studyStart: string, faculty: string, fio: string }} Объект студента
 */
 ...
 * @returns {{ id: string, name: string, surname: string, lastname: string, birthday: string, studyStart: string, faculty: string, fio: string }[]} Массив студентов
 */
 ...
 * @returns {{ id: string, name: string, surname: string, lastname: string, birthday: string, studyStart: string, faculty: string, fio: string, createdAt: string, updatedAt: string}} Объект студента
 */
 ...
 * @param {{ name?: string, surname?: string, lastname?: string, birthday?: string, studyStart?: string, faculty?: string, fio: string }} data - Объект с изменяемыми данными
 * @throws {ApiError} Студент с таким ID не найден (statusCode 404)
 * @throws {ApiError} Некорректные данные в аргументе (statusCode 422)
